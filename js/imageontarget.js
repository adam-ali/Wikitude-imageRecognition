var World = {
	...
	createOverlays: function createOverlaysFn() {
		...
		*/
		...
		this.tracker = new AR.ImageTracker(this.targetCollectionResource, {
			...
			onError: function(err){
				AR.logger.error(`Error in image tracker: ${err}`);
			}
		});
	...
	worldLoaded: function worldLoadedFn() {
		var cssDivLeft = " style='display:alert table-cell;vertical-align: middle; text-align: right; width: 50%; padding-right: 15px;'";
